...
public class TestExceptionList extends TestCase {
  ...
  public void testWrappedException() throws Throwable {
    ...
    ExtRuntimeException           rtEx    = new ExtRuntimeException((Throwable)argEx);
    ExtIndexOutOfBoundsException  indexEx = new ExtIndexOutOfBoundsException((Throwable)argEx);
    ExtIndexOutOfBoundsException  bigEx   = new ExtIndexOutOfBoundsException((Throwable)rtEx); 
