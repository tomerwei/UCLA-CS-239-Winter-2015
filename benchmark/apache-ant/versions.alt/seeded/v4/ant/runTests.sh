...
$JAVA_HOME/bin/java -mx48m -classpath ${CLASSPATH}:${JAVA_HOME}/lib/classes.zip -Dant.home=bootstrap -Dbuild.tests=${current}/build/testcases -Dtests-classpath.value=${CLASSPATH} $* AntTestSuite
