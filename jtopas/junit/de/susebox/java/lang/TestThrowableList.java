 ...
 * @author  Heiko Blau
 */
public class TestThrowableList extends TestCase {
  ...
  public void testWrappedThrowable() throws Throwable {
    ...
    assertTrue("rtEx: Didn't retrieve the wrapped exception.", rtEx.nextThrowable() == argEx);
    ...
    assertTrue("indexEx: Didn't retrieve the wrapped exception.", indexEx.nextThrowable() == argEx);
    ...
    assertTrue("bigEx: Didn't retrieve the first wrapped exception.", bigEx.nextThrowable() == rtEx);
    assertTrue("bigEx: Didn't retrieve the second wrapped exception.", ((ThrowableList)bigEx.nextThrowable()).nextThrowable() == argEx);
  ...
  public void testThrowableList() throws Throwable {
    ...
    assertTrue("rtEx2: Didn't retrieve the nested exception.", rtEx2.nextThrowable() == rtEx1);
    assertTrue("indexEx: Didn't retrieve the first nested exception.", indexEx.nextThrowable() == rtEx2);
    assertTrue("indexEx: Didn't retrieve the second nested exception.", ((ThrowableList)indexEx.nextThrowable()).nextThrowable() == rtEx1);
