/*
 * JTopasTestSuite.java: JUnit test for the jtopas package
 *
 ...
 * @author  Heiko Blau
 */
public class JTopasTestSuite extends TestCase {
  ...
  public static void main(String[] args) {
    String[]   tests = { JTopasTestSuite.class.getName() };
   ...
   * Constructor
   */
  public JTopasTestSuite(String name) {
    super(name);
  }
}
