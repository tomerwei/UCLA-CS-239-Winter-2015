...
public class TestTokenizerProperties 
  ...
  static final TokenizerProperty[] _testProperties = {
    ...
    new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "Ê" }, null, TokenizerProperties.F_NO_CASE ),
    new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "¯" }, null, TokenizerProperties.F_NO_CASE ),
    new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "˛" }, null, TokenizerProperties.F_NO_CASE ),
    new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "ﬁute" }, null, TokenizerProperties.F_NO_CASE )
  };
