...
public class PluginTokenizer extends AbstractTokenizer {
   ...
   *
   * @param dataSource    the new source for the {@link de.susebox.java.util.AbstractTokenizer#read} method
   */
   ...
   * position. It should use {@link de.susebox.java.util.Tokenizer#getChar} 
   * to retrieve a character to check.
   *<br>
