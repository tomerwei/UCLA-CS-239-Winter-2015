  ...
  implements  WhitespaceHandler, SequenceHandler
{
  ...
  public static Test suite() {
    TestSuite   suite = new TestSuite(TestPluginTokenizer.class.getName());
  ...
  private static final TokenizerProperty  AUML_TAG 
    = new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "&auml;" }, "‰", Tokenizer.F_NO_CASE );

  private static final TokenizerProperty  OUML_TAG 
    = new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "&ouml;" }, "ˆ", Tokenizer.F_NO_CASE );

  private static final TokenizerProperty  UUML_TAG 
    = new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "&uuml;" }, "¸", Tokenizer.F_NO_CASE );

  private static final TokenizerProperty  SZLIG_TAG 
    = new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "&szlig;" }, "ﬂ", Tokenizer.F_NO_CASE );
}
