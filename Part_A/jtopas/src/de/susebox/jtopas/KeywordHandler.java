 ...
 *</p><p>
 * This interface is deprecated. Use the new {@link de.susebox.jtopas.spi.KeywordHandler}
 * interface in the SPI package instead.
 *</p>
 *
 * @see de.susebox.java.util.Tokenizer
 * @see de.susebox.java.util.AbstractTokenizer
 * @author Heiko Blau
 * @deprecated  Replaced by {@link de.susebox.jtopas.spi.KeywordHandler} 
 *              (<code>de.susebox.jtopas.spi.KeywordHandler</code>)
 */
public interface KeywordHandler extends Plugin {
   ...
   * use {@link de.susebox.java.util.Tokenizer#getText} or 
   * {@link de.susebox.java.util.AbstractTokenizer#getTextUnchecked} to retrieve it.
   *
