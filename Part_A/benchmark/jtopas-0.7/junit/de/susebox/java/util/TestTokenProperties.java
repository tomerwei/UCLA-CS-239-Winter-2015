...
public class TestTokenProperties extends TestCase {
  ...
  public static Test suite() {
    TestSuite   suite = new TestSuite(TestTokenProperties.class.getName());
    ...
    while (_tokenizer.hasMoreToken()) {
      ...
      switch (token.getType()) {
        ...
        case Token.SEPARATOR:
          assertTrue("End column " + token.getEndColumn() + " is not the successor of start column " + token.getStartColumn(),
