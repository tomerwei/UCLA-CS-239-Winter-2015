...
public class TestTokenizerProperties 
  ...
  public void testDataHandlers() throws Throwable {
    ...
    for (int index = 0; index < _patternMatchingStrings.length; ++index) {
      ...
      _currDataLength = image.length();
      System.arraycopy(image.toCharArray(), 0, _currData, _currStartPos, _currDataLength);
      assertTrue("Pattern matching failed for: " + image, ph.matches(this, false, lengthOfMatch) != null );
      assertTrue("Pattern matching returned wrong length: " + lengthOfMatch[0], lengthOfMatch[0] == image.length());
  ...
  public void testAddingSequences() throws Throwable {
    ...
    _properties.addSpecialSequence("¤", null, TokenizerProperties.F_NO_CASE);
    _properties.addSpecialSequence("¤uro", null, TokenizerProperties.F_NO_CASE);
    _properties.addSpecialSequence("µ", null, TokenizerProperties.F_NO_CASE);
    ...
    assertTrue("Couldn't find \"¤URO\".", _properties.specialSequenceExists("¤URO"));
    assertTrue("Couldn't find \"µ\".",    _properties.specialSequenceExists("µ"));
    ...
    assertTrue("More / less special sequences than expected: " + count, count == 8);
    ...
    _properties.removeSpecialSequence("µ");
    assertTrue("Still found \"µ\".", ! _properties.specialSequenceExists("µ"));
  ...
  static final TokenizerProperty[] _testProperties = {
    ...
    new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "+" }, null, TokenizerProperties.F_CASE ),
    new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "¤" }, null, TokenizerProperties.F_CASE ),
    new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "¤uro" }, null, TokenizerProperties.F_CASE ),
    new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "æ" }, null, TokenizerProperties.F_NO_CASE ),
    new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "ø" }, null, TokenizerProperties.F_NO_CASE ),
    new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "þ" }, null, TokenizerProperties.F_NO_CASE ),
    new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "Þute" }, null, TokenizerProperties.F_NO_CASE )
  };
