...
public class TestEmbeddedTokenizer extends TestCase {
  ...
  public void testJavaTokenizer() throws Throwable {
    ...
    javaProps.setParseFlags(TokenizerProperties.F_TOKEN_POS_ONLY 
                          | TokenizerProperties.F_KEEP_DATA 
                          | TokenizerProperties.F_COUNT_LINES);
    docProps.setParseFlags(TokenizerProperties.F_NO_CASE);
  ...
  public void testEmbeddedTokenizer() throws Throwable {
    ...
    htmlProps.setParseFlags(TokenizerProperties.F_TOKEN_POS_ONLY 
                          | TokenizerProperties.F_KEEP_DATA 
                          | TokenizerProperties.F_COUNT_LINES);
    cssProps.setParseFlags (TokenizerProperties.F_TOKEN_POS_ONLY | TokenizerProperties.F_NO_CASE);
    jsProps.setParseFlags  (TokenizerProperties.F_TOKEN_POS_ONLY | TokenizerProperties.F_CASE);
