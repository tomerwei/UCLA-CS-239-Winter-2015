...
public class TestDifficultSituations extends TestCase {
  ...
  private static final String OERE              = "ø";
  private static final String BUG               = "ð";
  private static final String DOUBLE_BUG        = "ðð";
  ...
  public void testNonASCIICharacters() throws Throwable {
    Reader reader = new StringReader( "1¤ is an æ to much. Orøtakeðthis: ¤¤ or ¤uro and ðð.");
