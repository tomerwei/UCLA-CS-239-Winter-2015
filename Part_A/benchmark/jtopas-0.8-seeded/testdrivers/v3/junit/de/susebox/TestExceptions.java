...
public class TestExceptions extends TestCase {
  ...
  public void testWrappedException() throws Throwable {
    ...
    assertTrue("rtEx: Didn't retrieve the wrapped exception.", ex.nextThrowable() == argEx);
  ...
  public void testNestedExceptions() throws Throwable {
    ...
    assertTrue("ex1: Didn't retrieve the nested exception.", ex1.nextThrowable() == argEx);
    assertTrue("ex2: Didn't retrieve the first nested exception.", ex2.nextThrowable() == ex1);
    assertTrue("ex2: Didn't retrieve the second nested exception.", ((ThrowableList)ex2.nextThrowable()).nextThrowable() == argEx);
