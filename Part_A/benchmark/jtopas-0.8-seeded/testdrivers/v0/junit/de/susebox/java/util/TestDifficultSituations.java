...
public class TestDifficultSituations extends TestCase {
  ...
  public void testEOFInLineComment() throws Throwable {
    ...
    tokenizer.setParseFlags(Tokenizer.F_RETURN_WHITESPACES);
    tokenizer.addLineComment("//");
  ...
  public void testStringEscapes1() throws Throwable {
    ...
    tokenizer.setParseFlags(Tokenizer.F_RETURN_WHITESPACES | Tokenizer.F_COUNT_LINES);
    tokenizer.addString("\"", "\"", "\\");
  ...
  public void testNestedComments() throws Throwable {
    ...
    tokenizer.setParseFlags(Tokenizer.F_RETURN_WHITESPACES | Tokenizer.F_COUNT_LINES | Tokenizer.F_ALLOW_NESTED_COMMENTS);
    ...
    assertTrue("(16) newline behind block comment not recognized as literal", tokenizer.current().equals("\n"));
    ...
    assertTrue("(36) newline behind string not recognized as literal", tokenizer.current().equals("\n"));
    ...
    assertTrue("(46) newline behind string not recognized as literal", tokenizer.current().equals("\n"));
  ...
  public void testReaderSwitching() throws Throwable {
    ...
    InputStreamTokenizer  tokenizer = new InputStreamTokenizer(reader1);
    Token                 token;
    ...
    for (int readerIdx = 0; readerIdx < readers.length; ++readerIdx) {
      ...
      for (int ii = 0; ii <= 8; ii += 4) {
        ...
        assertTrue("Token not recognized as literal", tokenizer.current().equals(Integer.toString(ii)));
        assertTrue(tokenizer.hasMoreToken());
        token = tokenizer.nextToken();
        ...
        assertTrue("Separator not recognized as literal", tokenizer.current().equals("/"));
        assertTrue(tokenizer.hasMoreToken());
        token = tokenizer.nextToken();
        assertTrue("Wrong start position " + token.getStartPosition(), token.getStartPosition() == ii + 2);
        assertTrue("Wrong type " + token.getType(), token.getType() == Token.NORMAL);
        assertTrue("Token not recognized as literal", tokenizer.current().equals(Integer.toString(ii + 2)));
      }
    }
  }
  ...
  public void testDOSEOL() throws Throwable {
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(10) token \"void\" not recognized.", token.getType() == Token.NORMAL && token.getToken().equals("void"));
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(20) token \"main\" not recognized.", token.getType() == Token.NORMAL && token.getToken().equals("main"));
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(30) token \"(\" not recognized.", token.getType() == Token.SEPARATOR && token.getToken().equals("("));
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(40) token \"int\" not recognized.", token.getType() == Token.NORMAL && token.getToken().equals("int"));
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(50) token \"argc\" not recognized.", token.getType() == Token.NORMAL && token.getToken().equals("argc"));
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(60) token \")\" not recognized.", token.getType() == Token.SEPARATOR && token.getToken().equals(")"));
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(60) token \"\\r\\n\" not recognized.", token.getType() == Token.WHITESPACE && token.getToken().equals("\r\n"));
    assertTrue("(61) start line wrong", token.getStartLine() == 1);
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(70) token \"{\" not recognized.", token.getType() == Token.SEPARATOR && token.getToken().equals("{"));
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(120) token \"}\" not recognized.", token.getType() == Token.SEPARATOR && token.getToken().equals("}"));
  ...
  public void testMACEOL() throws Throwable {
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(60) token \"\\r\" not recognized.", token.getType() == Token.WHITESPACE && token.getToken().equals("\r"));
    assertTrue("(61) start line wrong", token.getStartLine() == 1);
    assertTrue("(62) start column wrong", token.getStartColumn() == 19);
    assertTrue("(63) end line wrong", token.getEndLine() == 2);
    assertTrue("(64) end column wrong", token.getEndColumn() == 0);
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(80) token \"\\r  \" not recognized.", token.getType() == Token.WHITESPACE && token.getToken().equals("\r  "));
    assertTrue("(81) start line wrong", token.getStartLine() == 2);
    assertTrue("(82) start column wrong", token.getStartColumn() == 1);
    assertTrue("(83) end line wrong", token.getEndLine() == 3);
    assertTrue("(84) end column wrong", token.getEndColumn() == 2);
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(110) token \"\\r\" not recognized.", token.getType() == Token.WHITESPACE && token.getToken().equals("\r"));
    assertTrue("(111) start line wrong", token.getStartLine() == 6);
    assertTrue("(112) start column wrong", token.getStartColumn() == 4);
    assertTrue("(113) end line wrong", token.getEndLine() == 7);
    assertTrue("(114) end column wrong", token.getEndColumn() == 0);
    ...
    assertTrue(tokenizer.hasMoreToken());
    token = tokenizer.nextToken();
    assertTrue("(130) token \"\\r\" not recognized.", token.getType() == Token.WHITESPACE && token.getToken().equals("\r"));
    assertTrue("(131) start line wrong", token.getStartLine() == 7);
    assertTrue("(132) start column wrong", token.getStartColumn() == 1);
    assertTrue("(133) end line wrong", token.getEndLine() == 8);
    assertTrue("(134) end column wrong", token.getEndColumn() == 0);
